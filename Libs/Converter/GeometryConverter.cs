...
namespace SharpMap.Converters.NTS
{
    ...
    public static class GeometryConverter
    {
        ...
        {
            List<SharpMap.Geometries.Point> vertices = new List<SharpMap.Geometries.Point>(5);
        ...
        {
            List<SharpMap.Geometries.Point> vertices = new List<SharpMap.Geometries.Point>();
        ...
        internal static SharpMap.Geometries.Polygon ToSharpMapPolygon(GisSharpBlog.NetTopologySuite.Geometries.Polygon polygon)
        {
            ...
            List<SharpMap.Geometries.LinearRing> interiorRings = new List<SharpMap.Geometries.LinearRing>();
