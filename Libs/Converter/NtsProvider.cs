    ...
    public class NtsProvider : IProvider
    {
        ...
        {            
            ...
            try
            {
                ...
                provider.Open();                
                List<uint> ids = provider.GetObjectIDsInView(provider.GetExtents());             
        ...
        public List<SharpMap.Geometries.Geometry> GetGeometriesInView(SharpMap.Geometries.BoundingBox bbox)
        {
            ...
            List<SharpMap.Geometries.Geometry> geoms = new List<SharpMap.Geometries.Geometry>(features.Count);
            foreach (GisSharpBlog.NetTopologySuite.Features.Feature feature in features)
